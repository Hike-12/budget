...
export default function Navbar() {
  ...
  return (
    <motion.nav
      ...
      className="fixed top-0 left-0 max-w-full w-full z-50 bg-transparent backdrop-blur-md border-b border-white/10"
    >
      <div className="w-full px-4 sm:px-6 lg:px-10 xl:pl-32 py-4">
        <div className="max-w-7xl w-full flex items-center justify-between">
          <Link
            href="/"
            className="flex items-center gap-3 font-grotesk text-2xl text-accent font-bold group focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/50 rounded-md p-1"
          >
